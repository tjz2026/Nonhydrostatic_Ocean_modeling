...
%
u=mexnc('varget',ncid,'u',[(itime-1) 0 0 0],[1 -1 -1 -1],1);
v=mexnc('varget',ncid,'v',[(itime-1) 0 0 0],[1 -1 -1 -1],1);
%
% Get mask:
%
...
rot=mexnc('varget',ncid,'rot',[0 0],[-1 -1],1);
%
% Get depth and surface elevation:
%
h=mexnc('varget',ncid,'h',[0 0],[-1 -1]);
elb=mexnc('varget',ncid,'elb',[(itime-1) 0 0],[1 -1 -1],1);
%
% Get sigma:
%
